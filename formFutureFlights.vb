Public Class formFutureFlights
    Private Sub formFutureFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Dim strSelect As String = "SELECT TFlightPassengers.intFlightPassengerID, TFlightPassengers.intFlightID, " &
                              "TFlightPassengers.intPassengerID, TFlightPassengers.strSeat, " &
                              ...
                              "WHERE TFlightPassengers.intPassengerID = " & intCustomerID & " " &
