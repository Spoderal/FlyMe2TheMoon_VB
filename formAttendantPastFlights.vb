Public Class formAttendantPastFlights
    Private Sub formAttendantPastFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Dim strSelect As String = "SELECT TAttendantFlights.intAttendantFlightID, TAttendantFlights.intFlightID, " &
                              ...
                              "WHERE TAttendantFlights.intAttendantID = " & intAttendantID & " " &
