Public Class formAttendantFutureFlights
    Private Sub formAttendantFutureFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Dim cmdSelect As New OleDb.OleDbCommand("uspAttendantFutureFlights", m_conAdministrator)
